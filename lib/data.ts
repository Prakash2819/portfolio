...
export const certificates = [
  {
    ...
    description: "Demonstrated understanding of AWS cloud concepts, core services, and deployment fundamentals.",
  ...
  },
  {
    ...
    institution: "Udemy",
    duration: "Issued: Sep 2025",
    description: "Completed advanced training on deploying, managing, and scaling applications using Kubernetes.",
